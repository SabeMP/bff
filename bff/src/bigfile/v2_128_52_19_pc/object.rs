...
fn body_parser(decompressed_size: u32, compressed_size: u32, compression_type: &CompressionType) -> BinResult<Vec<u8>> {
    if compressed_size == 0 {
		...
		match compression_type {
			CompressionType::Zlib => zlib_decompress_body_parser(reader, endian, (decompressed_size, compressed_size)),
			CompressionType::LZ4 => lz4_decompress_body_parser(reader, endian, (decompressed_size, compressed_size)),
